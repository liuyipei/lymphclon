...
simple.precision.weights <- matrix(reads.per.replicate, nrow=6) %*% matrix(reads.per.replicate, ncol=6)
...
etr2<-merge(estimator.table.raw, estimator.table.raw, by = c()) # etr2 stands for estimator.table.raw [cross product] estimator.table.raw
